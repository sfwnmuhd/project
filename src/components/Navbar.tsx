  ...
  return (
    ...
    >
      <div className='container mx-auto flex justify-between items-center py-4 px-4 sm:px-6 lg:px-6'>
        ...
        {/* Mobile menu */}
        {showMobileMenu && (
          <div className='lg:hidden fixed inset-0 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 backdrop-blur-xl z-50 transition-all duration-300 h-1/2'>
